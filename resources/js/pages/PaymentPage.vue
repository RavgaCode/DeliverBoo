<template>
    <div class="container">
        ...
        <div class="user-info">
            ...
            <!-- User-Adress -->
             <div>
                ...
                <input type="text" id="adress" name="adress" placeholder="Inserisci il tuo indirizzo">
            </div>
            <!-- User-Email -->
             <div>
        ...
        <div class="payment">
            <div class="wrapper">
                <div class="user-payment d-flex justify-content-between p-2 align-items-center">
                    <div>
                        Pay with card
                    </div>
                    <div class="avaible-card">
                        ...
                        <img src="../images/maestro-card.png" alt="maestro-card">
                        <img src="../images/american-express-card.png" alt="amirican-express-card">
